...
class BeremizPLCObjectServiceService(erpc.server.Service):
    def __init__(self, handler):
        ...
        self._methods = {
                ...
                interface.IBeremizPLCObjectService.GETSDOENTRIESDATA_ID: self._handle_GetSDOEntriesData,
                interface.IBeremizPLCObjectService.SETSDOTRACEVALUES_ID: self._handle_SetSDOTraceValues,
                interface.IBeremizPLCObjectService.GETSDODATA_ID: self._handle_GetSDOData,
                interface.IBeremizPLCObjectService.STOPSDOTHREAD_ID: self._handle_StopSDOThread,
            }
    ...
    def _handle_GetSDOEntriesData(self, sequence, codec):
        # Create reference objects to pass into handler for out/inout parameters.
        ...
        entries = []
        for _i0 in range(_n0):
            _v0 = common.SDOEntry()._read(codec)
            entries.append(_v0)

        slavePos = codec.read_uint16()

        # Invoke user implementation of remote function.
        _result = self._handler.GetSDOEntriesData(entries, slavePos, result)
        ...
        codec.start_write_message(erpc.codec.MessageInfo(
            type=erpc.codec.MessageType.kReplyMessage,
            service=interface.IBeremizPLCObjectService.SERVICE_ID,
            request=interface.IBeremizPLCObjectService.GETSDOENTRIESDATA_ID,
            sequence=sequence))
        if result.value is None:
            raise ValueError("result.value is None")
        codec.start_write_list(len(result.value))
        for _i0 in result.value:
            _i0._write(codec)

        codec.write_uint32(_result)

    def _handle_SetSDOTraceValues(self, sequence, codec):
        # Create reference objects to pass into handler for out/inout parameters.
        result = erpc.Reference()
        ...
        # Invoke user implementation of remote function.
        _result = self._handler.SetSDOTraceValues(entries, slavePos, result)
        ...
        codec.start_write_message(erpc.codec.MessageInfo(
            type=erpc.codec.MessageType.kReplyMessage,
            service=interface.IBeremizPLCObjectService.SERVICE_ID,
            request=interface.IBeremizPLCObjectService.SETSDOTRACEVALUES_ID,
            sequence=sequence))
        if result.value is None:
            raise ValueError("result.value is None")
    ...
    def _handle_GetSDOData(self, sequence, codec):
        # Create reference objects to pass into handler for out/inout parameters.
        result = erpc.Reference()
        ...
        # Invoke user implementation of remote function.
        _result = self._handler.GetSDOData(result)
        ...
        codec.start_write_message(erpc.codec.MessageInfo(
            type=erpc.codec.MessageType.kReplyMessage,
            service=interface.IBeremizPLCObjectService.SERVICE_ID,
            request=interface.IBeremizPLCObjectService.GETSDODATA_ID,
            sequence=sequence))
        if result.value is None:
            raise ValueError("result.value is None")
        result.value._write(codec)
        codec.write_uint32(_result)

    def _handle_StopSDOThread(self, sequence, codec):
        # Read incoming parameters.

        # Invoke user implementation of remote function.
        _result = self._handler.StopSDOThread()
        ...
        codec.start_write_message(erpc.codec.MessageInfo(
            type=erpc.codec.MessageType.kReplyMessage,
            service=interface.IBeremizPLCObjectService.SERVICE_ID,
            request=interface.IBeremizPLCObjectService.STOPSDOTHREAD_ID,
            sequence=sequence))
        codec.write_uint32(_result)
