...
private:
    ...
    /*! @brief Server shim for DebugControl of BeremizPLCObjectService interface. */
    erpc_status_t DebugControl_shim(erpc::Codec * codec, erpc::MessageBufferFactory *messageFactory, erpc::Transport * transport, uint32_t sequence);
};
