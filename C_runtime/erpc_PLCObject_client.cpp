...
// BeremizPLCObjectService interface DebugControl function client shim.
uint32_t BeremizPLCObjectService_client::DebugControl(uint8_t key)
{
    erpc_status_t err = kErpcStatus_Success;
    ...
    {
        codec->startWriteMessage(message_type_t::kInvocationMessage, m_serviceId, m_DebugControlId, request.getSequence());
    ...
    // Invoke error handler callback function
    m_clientManager->callErrorHandler(err, m_DebugControlId);
