...
/* ------------------------------------------------------------------
 * EtherCAT C code template, for Xenomai or plain Linux
 * ------------------------------------------------------------------ */
#include <time.h>
#include <stdint.h>
#include <stdio.h>
...
/* Target selection : define USE_XENOMAI to build against Xenomai */
...
/* Calculate the first wake up time, phased on the frame period */
uint64_t calculate_first(void)
{
